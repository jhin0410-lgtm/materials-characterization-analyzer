"""Review the unresolved public TEM source-frame/training-parent similarity pair."""
...
from mca.tem_parent_similarity_review import load_config, run_similarity_review, validate_public_config
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--config",
        default="case_studies/public_cobalt_oxide_tem_parent_similarity_review/case_config.json",
        help="Pinned public-case JSON configuration.",
    )
    parser.add_argument(
        "--output",
        default="outputs/public-cobalt-oxide-tem-parent-similarity-review",
