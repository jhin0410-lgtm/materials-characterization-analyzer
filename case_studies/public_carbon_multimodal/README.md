...
`W_sp` is **not** an empty-crucible mass and `W_sm` is **not** a sample-plus-crucible mass. The case config records the source meanings explicitly and states that neither missing quantity was inferred.
